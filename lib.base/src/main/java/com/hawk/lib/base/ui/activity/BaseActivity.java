...
public abstract class BaseActivity<V extends BaseDisplay, P extends BasePresenter<V>, C extends BaseComponent<V, P>>
        extends MvpDiActivity<V, P, C> implements TransactionCommitter {
